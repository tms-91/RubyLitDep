...
require 'model/runcheckscript'

class RunCheckScriptParser < BlockCommandParser
  ...
  def parse(lines,nr)
    ...
    return RunCheckScript.new(id,snippet, section, filename, platform, executor,varname)
  end
end